...
(cort-deftest-with-equal normalize-list-in-list--distribute
  '(((leaf-normalize-list-in-list 'a                         'dotlist 'distribute) '((a)))
    ((leaf-normalize-list-in-list '(a)                       'dotlist 'distribute) '((a . nil)))
    ((leaf-normalize-list-in-list '(a b c)                   'dotlist 'distribute) '((a . nil) (b . nil) (c . nil)))
    ((leaf-normalize-list-in-list '(a . b)                   'dotlist 'distribute) '((a . b)))
    ((leaf-normalize-list-in-list '(a . nil)                 'dotlist 'distribute) '((a . nil)))
    ((leaf-normalize-list-in-list '(a . 'nil)                'dotlist 'distribute) '((a . 'nil)))
    ((leaf-normalize-list-in-list '(a . 'b)                  'dotlist 'distribute) '((a . 'b)))
    ((leaf-normalize-list-in-list '(a . `b)                  'dotlist 'distribute) '((a . `b)))
    ((leaf-normalize-list-in-list '(a . #'b)                 'dotlist 'distribute) '((a . #'b)))
    ...
    ((leaf-normalize-list-in-list '(a . `(b ,c))             'dotlist 'distribute) '((a . `(b ,c))))
    ((leaf-normalize-list-in-list '(a . (lambda (v) v))      'dotlist 'distribute) '((a . (lambda (v) v))))
    ((leaf-normalize-list-in-list '(a . '(lambda (v) v))     'dotlist 'distribute) '((a . '(lambda (v) v))))
    ((leaf-normalize-list-in-list '(a . #'(lambda (v) v))    'dotlist 'distribute) '((a . #'(lambda (v) v))))

    ((leaf-normalize-list-in-list '(a z . b)                 'dotlist 'distribute) '((a . b) (z . b)))
    ((leaf-normalize-list-in-list '(a z . nil)               'dotlist 'distribute) '((a . nil) (z . nil)))
    ((leaf-normalize-list-in-list '(a z . 'nil)              'dotlist 'distribute) '((a . 'nil) (z . 'nil)))
    ((leaf-normalize-list-in-list '(a z . 'b)                'dotlist 'distribute) '((a . 'b) (z . 'b)))
    ((leaf-normalize-list-in-list '(a z . `b)                'dotlist 'distribute) '((a . `b) (z . `b)))
    ((leaf-normalize-list-in-list '(a z . #'b)               'dotlist 'distribute) '((a . #'b) (z . #'b)))
    ((leaf-normalize-list-in-list '(a z . '(b c))            'dotlist 'distribute) '((a . '(b c)) (z . '(b c))))
    ((leaf-normalize-list-in-list '(a z . `(b ,c))           'dotlist 'distribute) '((a . `(b ,c)) (z . `(b ,c))))
    ((leaf-normalize-list-in-list '(a z . (lambda (v) v))    'dotlist 'distribute) '((a . (lambda (v) v)) (z . (lambda (v) v))))
    ((leaf-normalize-list-in-list '(a z . '(lambda (v) v))   'dotlist 'distribute) '((a . '(lambda (v) v)) (z . '(lambda (v) v))))
    ((leaf-normalize-list-in-list '(a z . #'(lambda (v) v))  'dotlist 'distribute) '((a . #'(lambda (v) v)) (z . #'(lambda (v) v))))

    ((leaf-normalize-list-in-list '((a) (b))                 'dotlist 'distribute) '((a . nil) (b . nil)))
    ((leaf-normalize-list-in-list '((a . b) (c . nil))       'dotlist 'distribute) '((a . b) (c . nil)))
    ((leaf-normalize-list-in-list '((a . b) (c . d))         'dotlist 'distribute) '((a . b) (c . d)))
    ((leaf-normalize-list-in-list '((a . 'b) (c . 'd))       'dotlist 'distribute) '((a . 'b) (c . 'd)))
    ((leaf-normalize-list-in-list '((a . 'b) (c . #'d))      'dotlist 'distribute) '((a . 'b) (c . #'d)))
    ((leaf-normalize-list-in-list '((a . 'b) (c . '(d e)))   'dotlist 'distribute) '((a . 'b) (c . '(d e))))
    ((leaf-normalize-list-in-list '((a . 'b) (c . `(d ,e)))  'dotlist 'distribute) '((a . 'b) (c . `(d ,e))))
    ((leaf-normalize-list-in-list '((a . 'b) (c . (lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . (lambda (v) v))))
    ((leaf-normalize-list-in-list '((a . 'b) (c . '(lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . '(lambda (v) v))))
    ((leaf-normalize-list-in-list '((a . 'b) (c . #'(lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . #'(lambda (v) v))))

    ((leaf-normalize-list-in-list '((a) (b z))                 'dotlist 'distribute) '((a . nil) (b . nil) (z . nil)))
    ((leaf-normalize-list-in-list '((a . b) (c z . nil))       'dotlist 'distribute) '((a . b) (c . nil) (z . nil)))
    ((leaf-normalize-list-in-list '((a . b) (c z . d))         'dotlist 'distribute) '((a . b) (c . d) (z . d)))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . 'd))       'dotlist 'distribute) '((a . 'b) (c . 'd) (z . 'd)))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . #'d))      'dotlist 'distribute) '((a . 'b) (c . #'d) (z . #'d)))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . '(d e)))   'dotlist 'distribute) '((a . 'b) (c . '(d e)) (z . '(d e))))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . `(d ,e)))  'dotlist 'distribute) '((a . 'b) (c . `(d ,e)) (z . `(d ,e))))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . (lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . (lambda (v) v)) (z . (lambda (v) v))))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . '(lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . '(lambda (v) v)) (z . '(lambda (v) v))))
    ((leaf-normalize-list-in-list '((a . 'b) (c z . #'(lambda (v) v))) 'dotlist 'distribute) '((a . 'b) (c . #'(lambda (v) v)) (z . #'(lambda (v) v))))

    ((leaf-normalize-list-in-list '((a b c) . nil)           'dotlist 'distribute) '((a . nil) (b . nil) (c . nil)))
    ((leaf-normalize-list-in-list '((a b c) . d)             'dotlist 'distribute) '((a . d) (b . d) (c . d)))
    ((leaf-normalize-list-in-list '((a b c) . 'd)            'dotlist 'distribute) '((a . 'd) (b . 'd) (c . 'd)))
    ((leaf-normalize-list-in-list '((a b c) . #'d)           'dotlist 'distribute) '((a . #'d) (b . #'d) (c . #'d)))
    ((leaf-normalize-list-in-list '((a b c) . (lambda (v) v)) 'dotlist 'distribute) '((a . (lambda (v) v)) (b . (lambda (v) v)) (c . (lambda (v) v))))
    ((leaf-normalize-list-in-list '((x . 'y) ((a b c) . nil)) 'dotlist 'distribute) '((x . 'y) (a . nil) (b . nil) (c . nil)))
    ((leaf-normalize-list-in-list '((x . y) ((a b c) . d))   'dotlist 'distribute) '((x . y) (a . d) (b . d) (c . d)))
    ((leaf-normalize-list-in-list '((x . 'y) ((a b c) . d)) 'dotlist 'distribute) '((x . 'y) (a . d) (b . d) (c . d)))
    ((leaf-normalize-list-in-list '((x . 'y) ((a b c) . 'd)) 'dotlist 'distribute) '((x . 'y) (a . 'd) (b . 'd) (c . 'd)))
    ((leaf-normalize-list-in-list '((x . 'y) ((a b c) . #'d)) 'dotlist 'distribute) '((x . 'y) (a . #'d) (b . #'d) (c . #'d)))
    ((leaf-normalize-list-in-list '((x . 'y) ((a b c) . (lambda (v) v))) 'dotlist 'distribute) '((x . 'y) (a . (lambda (v) v)) (b . (lambda (v) v)) (c . (lambda (v) v))))))
