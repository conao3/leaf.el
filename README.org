...
[[https://github.com/conao3/leaf.el][https://raw.githubusercontent.com/conao3/files/master/header/png/leaf.el.png]]
...
If you want other keywords, you can easily add them.
#+BEGIN_SRC emacs-lisp
  (leaf-add-doc-keyword :author)
  (leaf-add-doc-keyword :source)
#+END_SRC
